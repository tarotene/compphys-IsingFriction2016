...
set format x ""
plot "beta".beta."/eb_sweep/en_bulk_s".s."_sweep.bin" binary array=20000 format="%int%*9int" smooth unique lw 4 title "energy (bulk)"

set tmargin screen 0.5; set bmargin screen 0.1
set yrange [-l_x*l_y*l_z:l_x*l_y*l_z]
plot "beta".beta."/mb_sweep/m_bulk_s".s."_sweep.bin" binary array=20000 format="%int%*9int" smooth unique lw 4 title "magnetization (bulk)"
