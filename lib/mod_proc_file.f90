...
CONTAINS
  ...
  SUBROUTINE exportSnapshot_2d(slot, filename, len_x, len_z, spin)
    INTEGER(kind = 4), INTENT(in) :: slot
    CHARACTER(len = *, kind = 1), INTENT(in) :: filename
    INTEGER(kind = 4), INTENT(in) :: len_x, len_z
    ...
    END DO
    CLOSE(slot)
  END SUBROUTINE exportSnapshot_2d

  SUBROUTINE exportSnapshot_3d(slot, filename, len_x, len_y, len_z, spin)
    INTEGER(kind = 4), INTENT(in) :: slot
    CHARACTER(len = *, kind = 1), INTENT(in) :: filename
    INTEGER(kind = 4), INTENT(in) :: len_x, len_y, len_z
